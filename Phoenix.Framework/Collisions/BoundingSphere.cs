...
namespace Phoenix.Framework.Collisions
{
    ...
    public class BoundingSphere : IEquatable<BoundingSphere>
    {
        ...
        {
            float sqDistance = Vector3.DistanceSquared(Center, sphere.Center);
        ...
        public ContainmentType Contains(Vector3 point)
        {
            ...
            float sqDistance = Vector3.DistanceSquared(Center, point);
        ...
        /// <summary>
        /// Creates the smallest <see cref="BoundingSphere"/> that can contain a specified <see cref="AxisAlignedBoundingBox"/>.
        /// </summary>
        /// <param name="box">The box to create the sphere from.</param>
        /// <returns>The new <see cref="BoundingSphere"/>.</returns>
        public static BoundingSphere CreateFromBoundingBox(AxisAlignedBoundingBox box)
        {
        ...
        {
            return other is not null && Center == other.Center && Radius == other.Radius;
        }
        ...
        /// <summary>
        /// Gets whether or not a specified <see cref="AxisAlignedBoundingBox"/> intersects with this sphere.
        /// </summary>
        /// <param name="box">The box for testing.</param>
        /// <returns><c>true</c> if <see cref="AxisAlignedBoundingBox"/> intersects with this sphere; <c>false</c> otherwise.</returns>
        ...
        public bool Intersects(BoundingSphere sphere)
        {
            ...
            var radii = sphere.Radius + Radius;
            return sqDistance < radii * radii;
        }
        ...
        {
            return new BoundingSphere(center: Vector3.Transform(Center, matrix),
                radius: Radius * MathF.Sqrt(Math.Max(((matrix.M11 * matrix.M11) + (matrix.M12 * matrix.M12)) +
